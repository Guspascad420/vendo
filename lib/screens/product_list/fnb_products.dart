...
class FNBProducts extends StatefulWidget {
  const FNBProducts({super.key, required this.favProducts,
  ...
  @override
  State<FNBProducts> createState() => _FNBProductsState();
}

class _FNBProductsState extends State<FNBProducts> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: FutureBuilder(
          future: Future.wait([futureFoodList, futureBeverageList]),
                ...
                child: Column(
                  children: [
                    ...
                    StaticGrid(
                        ...
                        padding: const EdgeInsets.symmetric(horizontal: 10),
                        children: [
                          for (var product in beverageList)
                            productCard(
                                context, product,
                                widget.isFavorite(product),
                                widget.onIconTapped, widget.addProductToCart,
